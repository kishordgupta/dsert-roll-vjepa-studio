...
from common import *
s=json.loads((ROOT/'synthetic-selection.json').read_text())
...
(ROOT/'synthetic-manifest.json').write_text(json.dumps(dict(dataset='jeongyh98/DSERT-RoLL',revision=s['revision'],split='val',samples=samples,files=manifest),indent=2))
